...
-- Table "Company" : Stocke les informations des entreprises
...
CREATE TABLE "Negotiation" (
  ...
  "companyID" INT REFERENCES "User"("userID") ON DELETE CASCADE, -- Clé étrangère vers la table "User"
...
CREATE TABLE "Media" (
  ...
  "companyID" INT REFERENCES "Company"("companyID") ON DELETE SET NULL, -- Clé étrangère vers la table "Company"
  "userID" INT REFERENCES "User"("userID") ON DELETE SET NULL, -- Clé étrangère vers la table "User"
