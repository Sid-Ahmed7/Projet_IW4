...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[uuid]' => 'Testing',
            'category[title]' => 'Testing',
            'category[description]' => 'Testing',
            'category[picture]' => 'Testing',
            'category[company]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'category[uuid]' => 'Something New',
            'category[title]' => 'Something New',
            'category[description]' => 'Something New',
            'category[picture]' => 'Something New',
            'category[company]' => 'Something New',
        ]);
