 ...
 */
final class Version20240212100240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD htprice INT ');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice DROP htprice');
