 ...
 */
final class Version20250807130718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP client_name');
        $this->addSql('ALTER TABLE devis DROP client_email');
        $this->addSql('ALTER TABLE devis DROP client_address');
        $this->addSql('ALTER TABLE devis DROP client_phone');
    }
